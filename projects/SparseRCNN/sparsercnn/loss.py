...
from .util.box_ops import box_cxcywh_to_xyxy, generalized_box_iou,complete_box_iou,distance_box_iou
...
class SetCriterion(nn.Module):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes):
        ...
        losses = {}
        loss_giou = 1 - torch.diag(box_ops.complete_box_iou(src_boxes, target_boxes))
        #print(1223)
